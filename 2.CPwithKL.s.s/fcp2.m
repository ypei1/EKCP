function [wage_level,rent_level, SecPrice_level,pie_level,...
    ...
    = fcp2(x0,y0, tech, kappa,labor,capital,inves, deficit)
...
pf0=ones(J,N); 
[pf0,cost_level,pie1,pfmax,it] = PH2(w0,r0,theta_all,gama_labor, gama_capital, gama_va, gama_njk,kappa,J,N,maxit,tolp,Gammar,A,tech) ;%pf0,cost1,pie1,pfmax,it
%%
